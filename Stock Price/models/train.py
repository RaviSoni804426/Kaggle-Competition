...
def train_model(
    ...
    # Split data (time-aware: use later data for testing)
    # Note: Since data is combined from multiple stocks, we do a random split
    # In production, you'd want a proper time-series split
    ...
    cv_scores = cross_val_score(
        XGBClassifier(**params, scale_pos_weight=class_weights[1]),
