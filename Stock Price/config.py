...
# These are minimum percentage gains to classify as positive (1)
TARGET_THRESHOLDS = {
    3: 1.5,   # 1.5% gain for 3-day horizon
    5: 2.5,   # 2.5% gain for 5-day horizon
    7: 3.5,   # 3.5% gain for 7-day horizon
    10: 5.0,  # 5.0% gain for 10-day horizon
    15: 7.0,  # 7.0% gain for 15-day horizon
}
